    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('moderator', 'Moderator'), ('admin', 'Admin')], default='user', max_length=40, verbose_name='User role')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='email address')),
                ('bio', models.TextField(blank=True, max_length=300, null=True, verbose_name='about me')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, help_text='Выберите категорию.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='titles', to='yamdb.category', verbose_name='Категория')),
                ('genre', models.ManyToManyField(blank=True, related_name='titles', to='yamdb.Genre', verbose_name='Жанр')),
            ],
            options={
                'ordering': ['-id'],
            },
